        ...
        $(function () {
            $("#username").blur(function () {
                ...
                if (username == null || username == "") {
                    ...
                    var url = "${pageContext.request.contextPath}/user_findByName.action?time=" +
                            new Date().getTime() + "&user.userName=" + username;
            ...
            $("#checkImg").click(function () {
                this.src = "${pageContext.request.contextPath}/checkImg.action?time=" + new Date().getTime();
            });
        });
    </script>
</head>
    ...
    <div class="span24">
        <div class="wrap">
            <div class="main clearfix">
                <div class="title"><strong>会员注册</strong>USER REGISTER</div>
                ...
                <form id="registerForm" action="${pageContext.request.contextPath}/user_register.action" method="post"
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" id="email" name="user.email" class="text" maxlength="200">
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="user.realName" class="text" maxlength="200"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="user.phone" class="text"/>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name="user.address" class="text" maxlength="200"/>
                        ...
                        <tr>
                            ...
                            <td>
                                <input id="submitButton" type="button" class="submit" value="同意以下协议并注册">
                            </td>
                        </tr>
                        <tr>
                            <th>&nbsp;
